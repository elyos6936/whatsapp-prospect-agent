    ...
    >
      <div className="flex h-full w-[min(38vw,360px)] flex-col items-center px-5">
        ...
        <div className="flex w-full shrink-0 flex-col items-center pt-8 pb-4">
          <p className="max-w-[280px] text-center text-[12px] leading-snug text-text-500">
            {helpLine}
          </p>
        </div>

        {/* Zone téléphone isolée */}
        <div className="flex min-h-0 w-full flex-1 items-center justify-center py-6">
          ...
          >
            {/* Boutons latéraux */}
            <div
              className="absolute -left-[3px] top-[14%] z-30 h-[3.2%] w-[3px] rounded-l-sm bg-gradient-to-b from-zinc-500 to-zinc-700"
              aria-hidden
            />
            <div
              className="absolute -left-[3px] top-[20%] z-30 h-[6%] w-[3px] rounded-l-sm bg-gradient-to-b from-zinc-500 to-zinc-700"
              aria-hidden
            />
            <div
              className="absolute -left-[3px] top-[28%] z-30 h-[6%] w-[3px] rounded-l-sm bg-gradient-to-b from-zinc-500 to-zinc-700"
              aria-hidden
            />
            <div
              className="absolute -right-[3px] top-[24%] z-30 h-[10%] w-[3px] rounded-r-sm bg-gradient-to-b from-zinc-500 to-zinc-700"
              aria-hidden
            />

            <div
              className="relative flex h-full w-full flex-col overflow-hidden rounded-[14%] p-[3.2%]"
              style={{
                background:
            ...
            >
              <div
                className="pointer-events-none absolute inset-0 z-20 rounded-[14%]"
                style={{
                  background:
              ...
              <div className="relative z-10 flex min-h-0 flex-1 flex-col overflow-hidden rounded-[11%] bg-black">
                {/* Dynamic Island */}
                <div className="pointer-events-none absolute left-1/2 top-[1.6%] z-30 h-[3.6%] w-[34%] -translate-x-1/2 rounded-full bg-black shadow-[0_0_0_1px_rgba(255,255,255,0.06)]">
                  <div className="absolute right-[16%] top-1/2 h-[38%] w-[9%] -translate-y-1/2 rounded-full bg-[#0c1220] ring-1 ring-zinc-800" />
                </div>

                <div className="relative z-20 flex items-center justify-between px-[7%] pb-1 pt-[3.2%] text-[clamp(9px,2.8vw,11px)] font-semibold tracking-tight text-white">
