...
// Visible soft brand-blue plasma on white — filled blobs, not gray / outlined rings.
const UNIFORMS = {
  colors: [
    [1, 1, 1], // white field
    [0.93, 0.96, 1], // whisper blue
    [0.82, 0.9, 0.99], // soft fill
    [0.55, 0.7, 0.95], // mid brand glow
    [0.22, 0.4, 0.85], // #2057CE-ish core (visible bubble color)
    [0.72, 0.84, 0.98], // soft edge
    [0.96, 0.97, 1],
    [1, 1, 1],
