...
/** Bulle d’aide — à monter uniquement depuis Paramètres (hors simulation chat). */
      ...
      {!open && (
        <button
          ...
          className={cn(
            ...
            'rounded-full bg-brand text-white shadow-[0_12px_32px_-8px_rgba(59,111,214,0.55)]',
            'transition hover:scale-105 hover:opacity-95 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand',
          )}
      ...
      {open && (
        <div
          className={cn(
            ...
            'bottom-5 right-5 h-[min(78vh,560px)] w-[min(400px,calc(100vw-1.5rem))]',
