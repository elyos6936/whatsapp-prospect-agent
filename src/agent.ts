...
const FORCE_SIMULATION_NUDGE =
  ...
  "Les tours suivants : même mission / pacing (pousser l'intérêt, pas de « Ah super » / « Super. » vide), " +
  "MÊME ton d'adressage que l'accroche validée (si elle tutoie, tu tutoies partout ; si elle vouvoie, tu vouvoies partout — jamais un mélange), " +
  "sans prénom du prospect à tout va. " +
